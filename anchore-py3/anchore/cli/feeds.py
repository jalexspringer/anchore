    ...
    try:
        ...
        for feed in list(feedmeta.keys()):
            if feedmeta[feed]['subscribed']:
                ...
                if showgroups:
                    subscribed[feed]['groups'] = list(feedmeta[feed]['groups'].keys())
                ...
                if showgroups and collection == available:
                    collection[feed]['groups'] = list(feedmeta[feed]['groups'].keys())
            ...
            if not rc:
                ...
                if delete:
                    ...
                    if dontask:
                        ...
                        try:
                            answer = input("Really delete feed data ("+str(feed)+"'? (y/N)")
                        except:
                            answer = "n"
                        if 'y' == answer.lower():
                            dodelete = True
