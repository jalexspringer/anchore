...
class AnchoreImageDB_FS(anchore_image_db_base.AnchoreImageDB):
    ...
    def save_image_new(self, imageId, report=None):
        ...
        for module_name in list(report['analysis_report'].keys()):
            for module_value in list(report['analysis_report'][module_name].keys()):
        ...
        for gname in list(report['gates_report'].keys()):
